...
public class DictionaryValuesNode<K, V> extends DualGenericNode<K, V> {
    ...
    public DictionaryValuesNode(WireType<K> type1, WireType<V> type2) {
        super("dictionary_values", type1 == null || type2 == null ? "Dictionary Values" : type1.getName() + " " + type2.getName() + " Dictionary Values", "Gets the values of a dictionary.", Items.BOOK, type1, type2);
